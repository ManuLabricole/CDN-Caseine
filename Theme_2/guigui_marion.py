...
if answer == "oui":
    ...
    # Both are negative
        ...
        print("Tous les deux en negqtif !") 
    ...
    # Guillaume is negative
        ...
        if abs(accountGui) < abs(accountMar):
            ...
            print("(Il lui restera :" + " " + str(abs(accountMar)-abs(accountGui)) + "euros)")
        else:
    ...
    # Guillaume peut l aider
        if abs(accountMar) < abs(accountGui):
            ...
            print("(Il lui restera :" + " " + str(abs(accountGui)-abs(accountMar)) + "euros)")
        else:
            print("Impossible de retablir la situation")
